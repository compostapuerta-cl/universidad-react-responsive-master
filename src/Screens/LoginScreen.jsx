...
function SvgTop() {
    ...
    <Defs>
        ...
        >
        <Stop stopColor="#32AE59" />
        <Stop offset={1} stopColor="#32AE59" />
        </LinearGradient>
        <LinearGradient
...
return (
    ...
    <View style={styles.titulocontainer}>
        <Image style={styles.imgLogo} source={require("../../assets/logo_undc.png")}/>
    </View>
    <View style={styles.container}>
        ...
        <ButtonGradient/>
        <Text style={styles.forgotPassword}>No tiene cuenta, Crear una?</Text>
